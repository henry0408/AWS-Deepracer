...
def reward_function(params):
    ...
    def select_speed(waypoints, closest_waypoints, future_step):
        ...
        diff_heading= identify_corner(waypoints,closest_waypoints,future_step)
    ...
    need_turn = direction_reward(waypoints, closest_waypoints, heading)
    if need_turn == False:
        reward += 0.1
